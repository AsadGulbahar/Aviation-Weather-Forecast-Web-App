...
export default class Ipad extends Component {
	...
	getURL() {
		let url = `https://api.openweathermap.org/data/2.5/weather?appid=a5b9429fea15ab8b64b5e9dda0ea818d&units=metric`;
		let forecasturl = `https://api.openweathermap.org/data/2.5/forecast?appid=a5b9429fea15ab8b64b5e9dda0ea818d&units=metric`;
